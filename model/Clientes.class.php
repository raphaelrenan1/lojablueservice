...
class Clientes extends Conexao{
    ...
    function Inserir(){
    	if($this->GetClienteCPF($this->getCli_cpf()) > 0){
    		echo '<div class="alert alert-danger " id="erro_mostrar"> Este CPF já existe<br>';
    	...
    	if($this->GetClienteEmail($this->getCli_email()) > 0){
    		echo '<div class="alert alert-danger " id="erro_mostrar"> Este Email já existe<br>';
    		Sistema::VoltarPagina();
    		echo '</div>';
    		exit();
    	}
  ...
  $query = " INSERT INTO {$this->prefix}clientes (cli_nome, cli_sobrenome,cli_data_nasc,cli_rg,";
    ...
    function setCli_nome($cli_nome) {
        ...
        if(strlen($cli_nome) < 3):
              ...
              echo '<div class="alert alert-danger " id="erro_mostrar"> Digite seu nome <br>';
                Sistema::VoltarPagina();
                echo '</div>';
    ...
    function setCli_sobrenome($cli_sobrenome) {
        ...
        if(strlen($cli_sobrenome) < 3):
             echo '<div class="alert alert-danger " id="erro_mostrar"> Digite seu sobrenome <br>';
                Sistema::VoltarPagina();
                echo '</div>';
    ...
    function setCli_cpf($cli_cpf) {
        ...
        if(!Sistema::ValidarCPF($cli_cpf)):
                ...
                echo '<div class="alert alert-danger " id="erro_mostrar"> CPF Inválido ...<br> ';
                Sistema::VoltarPagina();
                echo '</div>';
    ...
    function setCli_ddd($cli_ddd) {
        ...
        if(strlen($ddd) != 2):
                echo '<div class="alert alert-danger " id="erro_mostrar"> DDD incorreto <br>';
                Sistema::VoltarPagina();
                echo '</div>';
    ...
    function setCli_uf($cli_uf) {
       ...
       if(strlen($uf) != 2): // 11111
                echo '<div class="alert alert-danger " id="erro_mostrar"> UF incorreto <br>';
                Sistema::VoltarPagina();
                echo '</div>';
    ...
    function setCli_cep($cli_cep) {
       ...
       if(strlen($cep) != 8):
                echo '<div class="alert alert-danger " id="erro_mostrar"> CEP incorreto, digite apenas números!! <br>';
                Sistema::VoltarPagina();
                echo '</div>';
    ...
    function setCli_email($cli_email) {
        ...
        if(!filter_var($cli_email, FILTER_VALIDATE_EMAIL)):
                ...
                echo '<div class="alert alert-danger " id="erro_mostrar"> Email incorreto <br>';
                Sistema::VoltarPagina();
                echo '</div>';
