...
//Alterar as informações para o Site funcionar no seu servidor !
...
//Alterar as informações do Banco de DADOS se precisar, porém já está hospedado em meu servidor próprio!
...
//Informações para envio de E-mail ( PHPMailler ) ! alterar com sua conta de e-mail !
      const EMAIL_HOST = "smtp-mail.outlook.com",
            EMAIL_USER = "raphaelrenan1@hotmail.com",
            EMAIL_NOME = "Loja Virtual de Teste PHP - Blue Service",
            EMAIL_SENHA = "Rzewgh06",
            EMAIL_PORTA = 587,
            EMAIL_SMTPAUTH = true,
