...
<div class="container">
    <div class="row">
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">                     
            <textarea class="form-control" id="txtinputarea" rows="6" name="txtinputarea" placeholder="Escreva sua opinião, crítica ou sugestão para a nossa loja virtual"></textarea>
          </div>
        </div>
