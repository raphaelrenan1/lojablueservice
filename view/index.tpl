        ...
        <div class="container-fluid">
            ...
            <div class="row" id="topo">
                ...
                <div class="container">
                    ...
                    <div class="col-md-6">
                         <img src="{$GET_TEMA}/images/logo.png" alt=""><h2><b><i>{$GET_NOME}</i></b></h2>
                    </div>

                    <div class="col-md-6 text-right">
                            
                                     <br>{if $LOGADO == true}
                                      <b>Seja bem-vindo, {$USER} </b><a href="{$PAG_LOGOFF}" class="btn btn-info"><i class="glyphicon glyphicon-log-out"></i> Sair </a> 
                                     {/if}
            ...
            <div class="row" id="rodape">
                <center>
                    <h4>{$TITULO_SITE}</h4>
                    <P>Todos os Direitos Reservados - Raphael Renan - Data Atual: {$DATA}</P>
                </center>
